...
\begin{frame}{Model representations}
  \small
  \begin{tabular}{@{}p{0.20\textwidth}p{0.30\textwidth}p{0.40\textwidth}@{}}
    \toprule
    Representation & Strength & Watch for\\
    \midrule
    DFG & Fast, readable overview & No complete execution semantics\\
    Process tree & Structured, sound by construction & Restricts model shape\\
    Petri net & Precise concurrency and replay & Harder for non-specialists\\
    BPMN & Familiar business notation & Semantics vary by usage\\
    Transition system & State-based behavior & State explosion\\
    \bottomrule
  \end{tabular}
  \vspace{0.5cm}
